...
public final class SecretReference implements ConnectorValueReference {
    ...
    public SecretReference(final String providerId, final String secretName) {
    ...
    public boolean equals(final Object object) {
        ...
        return Objects.equals(providerId, that.providerId) && Objects.equals(secretName, that.secretName);
    }

    @Override
    public int hashCode() {
        return Objects.hash(providerId, secretName);
    }

    @Override
    public String toString() {
        return "SecretReference[providerId=" + providerId + ", secretName=" + secretName + "]";
    }
}
